...
```python
FraunhoferPropagator(normalize: bool = True, fft_cache: Optional[prism.utils.transforms.FFTCache] = None)
```

Far-field (Fraunhofer) diffraction propagator.

This is the actual propagation method used in PRISM via Telescope.propagate_to_kspace/propagate_to_spatial.
