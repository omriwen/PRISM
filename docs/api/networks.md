# prism.models.networks

Module: networks.py
Purpose: Neural network architectures for PRISM reconstruction
Dependencies: torch, numpy, prism.models.layers
...
```python
ProgressiveDecoder(input_size: 'int', output_size: 'int | None' = None, latent_channels: 'int | None' = None, channel_progression: 'list[int] | None' = None, num_upsample_layers: 'int | None' = None, use_bn: 'bool' = True, output_activation: 'str' = 'sigmoid', use_amp: 'bool' = False, use_leaky: 'bool' = True, middle_activation: 'str' = 'tanh', complex_data: 'bool' = False)
```
...
Notes:
    ...
    - Two-stage cropping: First to output_size, then pad to input_size
      (enables obj_size != image_size in PRISM)
...
See Also:
    ...
    - prism.models.layers: Layer components (DecoderUnit, CropPad, etc.)
