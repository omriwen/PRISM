# prism.core.propagators.angular_spectrum
...
```python
AngularSpectrumPropagator(grid: prism.core.grid.Grid, distance: Optional[float] = None, fft_cache: Optional[prism.utils.transforms.FFTCache] = None)
```
